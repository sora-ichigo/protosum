...
interface IFeatureServiceService_IGetFeatures extends grpc.MethodDefinition<proto_feature_feature_api_pb.Point, proto_feature_feature_api_pb.Feature> {
...
export interface IFeatureServiceServer extends grpc.UntypedServiceImplementation {
    ...
    getFeatures: grpc.handleUnaryCall<proto_feature_feature_api_pb.Point, proto_feature_feature_api_pb.Feature>;
}
...
export interface IFeatureServiceClient {
    ...
    getFeatures(request: proto_feature_feature_api_pb.Point, callback: (error: grpc.ServiceError | null, response: proto_feature_feature_api_pb.Feature) => void): grpc.ClientUnaryCall;
    getFeatures(request: proto_feature_feature_api_pb.Point, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_feature_feature_api_pb.Feature) => void): grpc.ClientUnaryCall;
    getFeatures(request: proto_feature_feature_api_pb.Point, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_feature_feature_api_pb.Feature) => void): grpc.ClientUnaryCall;
}
...
export class FeatureServiceClient extends grpc.Client implements IFeatureServiceClient {
    ...
    public getFeatures(request: proto_feature_feature_api_pb.Point, callback: (error: grpc.ServiceError | null, response: proto_feature_feature_api_pb.Feature) => void): grpc.ClientUnaryCall;
    public getFeatures(request: proto_feature_feature_api_pb.Point, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_feature_feature_api_pb.Feature) => void): grpc.ClientUnaryCall;
    public getFeatures(request: proto_feature_feature_api_pb.Point, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_feature_feature_api_pb.Feature) => void): grpc.ClientUnaryCall;
}
